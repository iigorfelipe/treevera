...
import { ChallengeBtn } from "@/modules/challenge/challenge-btn";
...
export const DailyChallenge = () => {
  ...
  return (
    <div className="px-4 py-6">
      <Card
        className={cn(
          "mx-auto w-full max-w-7xl rounded-2xl border bg-transparent shadow-sm",
          !viewChallenge && "cursor-pointer",
        )}
        onClick={() => setViewChallenge(true)}
      >
