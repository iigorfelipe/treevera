...
import { useGetSpeciesFavoritersInfinite } from "@/hooks/queries/useGetUserSeenSpecies";
...
export const SpecieFavoritersPage = () => {
  ...
  const {
    ...
    isFetchingNextPage,
    isLoading,
  } = useGetSpeciesFavoritersInfinite(gbifKey);
  ...
  const totalCount = data?.pages[0]?.totalCount ?? favoriters.length;
